...
- Canonical owner serialization is login/id only *(validate)*

## [0.6.1] - 2026-09-08

### Fixed

- Create the head pipeline before arming auto-merge *(gitlab)*

## [0.6.0] - 2026-08-25

### Added

- Configurable registries with credentials, and GHES *(policy)* **BREAKING**

## [0.5.1] - 2026-08-25

### Fixed

- Verify only the claims a pull request actually makes *(validate)*

## [0.5.0] - 2026-08-25

### Added

- Forge-neutral owners[], and one announce implementation **BREAKING**

## [0.4.2] - 2026-08-25

### Fixed

- Every compare link pointed at ocx-sdk-python *(changelog)*
- A forge timeout exited 1, the code meaning the PR is invalid *(adapters)*
...
- Follow a local composite action into the job that calls it *(workflows-check)*

## [0.3.1] - 2026-08-25

### Documentation

- Close plan_hardening_0_2_0 and record what the live run found *(plan)*

### Fixed

- GL-03 missed a token inside a block-scalar script *(gitlab-invariants)*

## [0.3.0] - 2026-08-25

### Added

- Audit a hand-written GitLab pipeline (GL-01, GL-03) *(workflows-check)*

### Documentation

- Measure Q3 against the live e2e, and record the stronger result *(research)*

### Fixed

- Resolve the base ref from the runner, not the literal 'main' *(policy)*
- A reclassified request stops carrying its old lane label *(governance)*
...
[0.6.2]: https://github.com/ocx-sh/indexbot/compare/v0.6.1..v0.6.2
[0.6.1]: https://github.com/ocx-sh/indexbot/compare/v0.6.0..v0.6.1
[0.6.0]: https://github.com/ocx-sh/indexbot/compare/v0.5.1..v0.6.0
[0.5.1]: https://github.com/ocx-sh/indexbot/compare/v0.5.0..v0.5.1
[0.5.0]: https://github.com/ocx-sh/indexbot/compare/v0.4.2..v0.5.0
[0.4.2]: https://github.com/ocx-sh/indexbot/compare/v0.4.1..v0.4.2
[0.4.1]: https://github.com/ocx-sh/indexbot/compare/v0.4.0..v0.4.1
[0.4.0]: https://github.com/ocx-sh/indexbot/compare/v0.3.1..v0.4.0
[0.3.1]: https://github.com/ocx-sh/indexbot/compare/v0.3.0..v0.3.1
[0.3.0]: https://github.com/ocx-sh/indexbot/compare/v0.2.2..v0.3.0
[0.2.2]: https://github.com/ocx-sh/indexbot/compare/v0.2.1..v0.2.2
[0.2.1]: https://github.com/ocx-sh/indexbot/compare/v0.2.0..v0.2.1
[0.2.0]: https://github.com/ocx-sh/indexbot/compare/v0.1.0..v0.2.0
